...
const App: React.FC = () => {
  ...
  const [files, setFiles] = useState<UploadedFiles>({
    aadhaar: null,
    passbook: null,
    signature: null, // still allowed to upload an optional signature image if needed
    dbtForm: null,
  });
  ...
  const resetFlow = () => {
    ...
    setFiles({ aadhaar: null, passbook: null, signature: null, dbtForm: null });
    setFormData({
      fullName: '',
      aadhaarNumber: '',
      accountNumber: '',
      ...
      case AppStep.SUCCESS:
        return (
          <div className="space-y-10">
            <BankGrid onDownload={handleDownloadPdf} />
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-4">
        {error && (
